...
public class KeyLock {
    ...
    public static boolean lock(String key) {
        return objectLockMap.putIfAbsent(key, new byte[1]) == null ? true : false;
    }
    ...
    public static void unlock(String txid) {
        if (objectLockMap.containsKey(txid))
            objectLockMap.remove(txid);
    }
}
